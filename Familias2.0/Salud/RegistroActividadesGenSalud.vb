...
Public Class RegistroActividadesGenSalud
    Dim dt As New DataTable

    Private Sub RegistroActividadesGenSalud_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BannerInfo()
        TipoList.Focus()
        valoresIniciales()
    End Sub
    ...
    Private Sub valoresIniciales()
        ...
        bdCombo(sql, TipoList, "Code", "actividad")
