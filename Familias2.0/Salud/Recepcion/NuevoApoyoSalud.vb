...
Public Class NuevoApoyoSalud
    Dim familyId As Integer

    Private Sub NuevoApoyoSalud_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BannerInfo()
        valoresIniciales()
    End Sub
    ...
    Private Sub GuardarButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GuardarButton.Click
        ...
        If NombresV.Text = "" Or ApellidosV.Text = "" Or GeneroCombo.Text = "" _
           Or RelFamiliarCombo.Text = "" Then
            MsgBox("Nombres, Apellidos y Género necesitan un valor", vbQuestion, "Misceláneos")
    ...
    Private Sub guardarNuevoEmpleado()
        Dim memberId As Integer = 1 + ultimoIdApoyoUnicoSalud()
        familyId = 1 + ultimoIdFamiliaApoyoUnicoSalud()
        ...
        Else
            MsgBox("Error al ingresar la familia del nuevo empleado", vbQuestion, My.Resources.versionFamilias2)
        End If
    End Sub
    ...
    Private Sub llenarComboRelFam()
        ...
        Else
            ...
            temp = "SELECT Code Codigo, DescSpanish AS Descripcion " + _
                     ...
                     "WHERE Active = 1 AND Gender = '" + CodigoGeneroL.Text + "'  AND Code like 'JEF%' " + _
