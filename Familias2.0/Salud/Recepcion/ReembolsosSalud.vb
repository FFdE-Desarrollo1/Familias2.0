...
Public Class ReembolsosSalud
    Public sMember As String

    Dim creat, formaPago, cheque, recibo, tipo, tipoPago As String
    Dim miembro As Integer

    Private Sub ReembolsosSalud_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BannerInfo()
    ...
    Private Sub listaReembolsos()
        sql = "SELECT 'Borrar' AS Borrar, 'Modificar' AS Modificar, CONVERT(nvarchar(30), MR.CreationDateTime, 21) AS Crea, MR.Type, " + _
              ...
              "cdT.DescSpanish AS Tipo, MR.Notes AS Observaciones, CAST(MR.Amount AS decimal(10, 2)) AS Cantidad, " + _
              "CAST(MR.ApprovedAmount AS decimal(10, 2)) AS 'Cantidad Aprobada', (MR.ApprovedAmount / MR.Amount) AS Porcentaje, " + _
              ...
              "WHERE MR.RecordStatus = ' ' AND MR.Project = '" + S + "' AND MR.MemberId = " + MiembroV.Text + " AND MR.FunctionalArea = 'CLIN' " + _
