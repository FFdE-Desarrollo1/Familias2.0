...
Public Class ReporteGeneralActividadesEduc
    Dim año As Integer = Today.Year

    Private Sub ReporteGeneralActividadesSalud_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BannerInfo()
        valoresIniciales()
    End Sub
    ...
    Private Sub listado()
        ...
        If TipoList.Text = "" Or TipoList.Text = " " Then
            where = where + " AND FunctionalArea = 'CLIN' "
        Else
    ...
    Private Sub valoresIniciales()
        sql = "SELECT DescSpanish FROM dbo.CdMemberActivityType " + _
                                "WHERE Active = 1 AND Project IN ('*', '" + S + "')  AND FunctionalArea = 'CLIN'  " + _
