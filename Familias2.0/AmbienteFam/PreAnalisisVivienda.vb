Public Class PreAnalisisVivienda
    Dim t As Integer = 0
    Dim aplica, codigo As String

    Private Sub PreAnalisisVivienda_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BannerInfo()
    ...
    Private Sub GuardarButton_Click(sender As Object, e As EventArgs) Handles GuardarButton.Click
        ...
        Else
            ...
            If bdEntero(sql, "T") = 1 Then
                MsgBox("Ingreso correcto", vbInformation, My.Resources.versionFamilias2)
                GuardarButton.Visible = False
            Else
                MsgBox("Revise el ingreso del analisis preliminar", vbInformation, My.Resources.versionFamilias2)
            End If
    ...
    Private Sub verificaInformacion()
        Dim msError = "El número de familia que ingresó no es válido" + Chr(13) + _
               "Verifique que sea una familia afiliada"
        If Char.IsNumber(FamiliaV.Text) = True Then
            If Len(FamiliaV.Text) > 0 Then
                If familiaEsAfiliada(S, Integer.Parse(FamiliaV.Text)) = True Then
                    GuardarButton.Visible = True
                    FamiliaV.ReadOnly = True

                    If tieneAnalisisPreliminar() = False Then
                        valoresIniciales()
                    Else
                        MsgBox("La familia ya tiene análisis preliminar de Vivienda", vbCritical, My.Resources.versionFamilias2)
                        FamiliaV.Text = ""
                    End If
                Else
            ...
            End If
        Else
            MsgBox("El número de familia debe ser solo números", vbCritical, My.Resources.versionFamilias2)
            FamiliaV.Text = ""
        End If
    End Sub
